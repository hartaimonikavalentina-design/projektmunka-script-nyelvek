...
# ---------------------------------------------------------
# PROJEKT SZÖVEG – BEILLESZTVE A HELYÉRE
# ---------------------------------------------------------
...
st.markdown("<h2 style='text-align:right;'>6. Interaktív megjelenítés</h2>", unsafe_allow_html=True)
