...
# ---------------------------------------------------------
# Hivatalos megszólítás – CÍM NÉLKÜL
# ---------------------------------------------------------
st.markdown("""
Tisztelt Dr. Tornai Kálmán dékánhelyettes, egyetemi docens úr!

A projektmunka interaktív elemei (grafikonok, csúszkák, térképes megjelenítés) a Google Colab környezetben futtathatók. 
A jegyzetfüzet teljes tartalmának megjelenítéséhez az alábbi lépések követése szükséges:
